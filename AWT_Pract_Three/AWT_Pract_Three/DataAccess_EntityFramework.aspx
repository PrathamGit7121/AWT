<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataAccess_EntityFramework.aspx.cs" Inherits="AWT_Pract_Three.DataAccess_EntityFramework" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div><h1>
                <asp:Label ID="Label1" runat="server" Text="Data Access Using Entity Framework"></asp:Label>
             </h1>
            <br />
